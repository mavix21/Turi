...
export const ProductVaultAbi = [
    ...
    outputs: [
      {
        ...
        internalType: "struct ProductVault.Seller",
        name: "",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [],
    name: "InsufficientTravelTokenAllowance",
    type: "error",
  },
  {
    inputs: [],
    name: "InsufficientTravelTokens",
    type: "error",
  },
  {
    inputs: [],
    name: "InsufficientUSDXAllowance",
    type: "error",
  },
  {
    inputs: [],
    name: "InsufficientUSDXBalance",
    type: "error",
  },
  {
    inputs: [],
...
export const TravelTokenAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract PlaceNFT",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum TravelCheckin.SkipReason",
        name: "reason",
        type: "uint8",
      },
    ],
